...
#define IRQN_CRC_Value                               0xDF			//根据手册加的
#define IRQN_TXD_Value                               0xF7
#define IRQN_RXD_Value                               (0x9F & IRQN_CRC_Value)
#define IRQN_CAD_Value                               0xFA
#define IRQN_SEELP_Value                             0xFF
#define PACKET_MIAX_Value                            0xff

/*
* @brief:	下面的寄存器都是例程未定义的，均摘抄自手册
* @author:	辰尘
* @date:	2023年12月19日22:04:46
*/
#define RegPacketConfig1							 0x30		//缺省值：0000 1001

...
/**
* @brief	分频废案，以433MHz为基准，频间距5MHz，频宽60Hz
* @date		12/17/23

//unsigned char Frequency[3] = { 0x6c, 0x90, 0x02 };//434.0Mhz，	通道0		缺省频率
//unsigned char Frequency[3] = { 0x6D, 0xCD, 0x6F };//439.0Mhz		通道1
//unsigned char Frequency[3] = { 0x6F, 0x0A, 0xDB };//443.9Mhz		通道2
//unsigned char Frequency[3] = { 0x70, 0x48, 0x48 };//448.9Mhz		通道3
//unsigned char Frequency[3] = { 0x71, 0x85, 0xB4 };//453.8Mhz		通道4
//unsigned char Frequency[3] = { 0x72, 0xC3, 0x21 };//458.8Mhz		通道5
//unsigned char Frequency[3] = { 0x74, 0x00, 0x8E };//463.7Mhz		通道6
//unsigned char Frequency[3] = { 0x75, 0x3D, 0xFA };//468.7Mhz		通道7
//unsigned char Frequency[3] = { 0x76, 0x7B, 0x67 };//473.7Mhz		通道8
//unsigned char Frequency[3] = { 0x77, 0xBB, 0xD3 };//478.6Mhz		通道9
//unsigned char Frequency[3] = { 0x78, 0xF6, 0x40 };//483.6Mhz		通道10
//unsigned char Frequency[3] = { 0x7A, 0x33, 0xAD };//488.5Mhz		通道11
//unsigned char Frequency[3] = { 0x7B, 0x71, 0x19 };//493.5Mhz		通道12 
*/
